...
```{r}
print("Holt-Winter Train and Test Set Metrics: ")
accuracy(NA.hwpred, na.val.ts)

print("Linear Regression Train and Test Set Metrics: ")
accuracy(nalm.pred, na.val.ts)

print("Neural Network Train and Test Set Metrics: ")
...
autoplot(sa.val.ts, ylab = "Temperature", main = "South America Validation Comparison")+
