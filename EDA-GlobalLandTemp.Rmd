...
acf(diff(na.train.ts), main = 'Autocorrelation of differenced NA Ts')
acf(na.train.ts, main = 'Autocorrelation of NA TS')
...
acf(diff(sa.train.ts), main = 'Autocorrelation of differenced SA Ts')
acf(sa.train.ts, main = 'Autocorrelation of SA TS')
...
acf(diff(eu.train.ts), main = 'Autocorrelation of differenced EU Ts')
acf(eu.train.ts, main = 'Autocorrelation of EU TS')
...
acf(diff(as.train.ts), main = 'Autocorrelation of differenced Asia Ts')
acf(as.train.ts, main = 'Autocorrelation of Asia TS')
...
acf(diff(au.train.ts), main = 'Autocorrelation of differenced Australia Ts')
acf(au.train.ts, main = 'Autocorrelation of Australia TS')
