---
title: "Appendix"
author: "Stephen Kuc, Luis Perez, Lane Whitmore"
date: "`r Sys.Date()`"
output:
...
Looking at the decomposition plot with the original timeplot, it is clear that the time series has an upward trend in addition to strong seasonality. Depending upon which models are used, the seasonality within the data may have to be removed by differencing. 
...
Similar to North America, there is clear seasonality and positive trend across this time series. The data does waver across the distribution a slight bit more in South America. 
...
Again, the time series has an upward trend, it looks more likely to be additive than multiplicative as the trendline is not increasing substantially over a large period of time. The data is also, once again seasonal.
...
Again, the trend looks to be on an upward movement while moving even less so than previous continents. The seasonality is still present. 
...
The trend line for Asia is a little steeper than other continents, perhaps suggesting that the temperature is increasing at a faster rate in Asia. 
...
plot(na.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n", 
     main = "North America Temperature with Holt-Winter's and Moving Average",cex.main=0.75))
...
```{r}
plot(na.train.ts, xlim = c(2000,2014),ylab = "Temperature",main = "North America Temperature with neural network")
...
legend(x = "bottomleft",
       legend=c("Train", "na_nn.pred$fitted","nalm.pred$fitted","na_nn.pred$mean","nalm.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
```
...
plot(eu.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n", 
      main = "Europe Temperature with Holt-Winter's and Moving Average", cex.main=0.75)
axis(side = 1, at = seq(1900, 2000, 10), labels = format(seq(1900, 2000, 10)))
...
```{r}
plot(eu.train.ts, xlim = c(2000,2014),ylab = "Temperature", main = "Europe Temperature with neural network")
...
legend(x = "bottomleft",
       legend=c("Train", "eu_nn.pred$fitted","eu.pred$fitted","eu.pred$mean","eu.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
```
...
plot(sa.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n",
    main = "South America Temperature with Holt-Winter's and Moving Average",cex.main=0.75)
axis(side = 1, at = seq(1900, 2000, 10), labels = format(seq(1900, 2000, 10)))
...
```{r}
plot(sa.train.ts, xlim = c(2000,2014),ylab = "Temperature", main = "South America Temperature with Neural Network")
...
legend(x = "bottomleft",
       legend=c("Train", "sa_nn.pred$fitted","salm.pred$fitted","sa_nn.pred$mean","salm.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
```
...
plot(af.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n",main = "Africa Temperature with Holt-Winter's and Moving Average", cex.main=0.75)
axis(side = 1, at = seq(1900, 2000, 10), labels = format(seq(1900, 2000, 10)))
...
The Linear regression model is boasting an adjusted r-squared of 0.95 which is a solid solution for the Africa model. 
...
```{r}
plot(af.train.ts, xlim = c(2000,2014),ylab = "Temperature",
     main = "Africa Temperature with Neural Network")
...
legend(x = "bottomleft",
       legend=c("Train", "af_nn.pred$fitted","aflm.pred$fitted","af_nn.pred$mean","aflm.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
...
plot(as.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n",  main = "Asia Temperature with Holt-Winter's and Moving Average", cex.main=0.75)
axis(side = 1, at = seq(1900, 2000, 10), labels = format(seq(1900, 2000, 10)))
...
```{r}
plot(as.train.ts, xlim = c(2000,2014), ylab = "Temperature",
     main = "Asia Temperature with Neural Network")
...
legend(x = "bottomleft",
       legend=c("Train", "as_nn.pred$fitted","aslm.pred$fitted","as_nn.pred$mean","aslm.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
```
...
plot(au.train.ts, ylab = "Temperature", xlab = "Year", bty = "l",  xaxt = "n", 
     main = "Australia Temperature with Holt-Winter's and Moving Average", flty = 2, cex.main=0.75)
axis(side = 1, at = seq(1900, 2000, 10), labels = format(seq(1900, 2000, 10)))
...
plot(au.train.ts, ylim = c(13, 30), xlim = c(2000,2014), ylab = "Temperature",
     main = "Australia Temperature with Neural Network")
...
legend(x = "bottomleft",
       legend=c("Train", "au_nn.pred$fitted","aulm.pred$fitted","au_nn.pred$mean","aulm.pred$mean"),
       fill = c("black","red","yellow","blue","green"))
```
...
na.fin.ts <- ts(na.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### NA linear model with seasonality and trend 
na.lm.fin <- tslm(na.fin.ts ~ trend + season)
nalm.fin.pred <- forecast(na.lm.fin, h = 12*75)

```

```{r}
autoplot(nalm.fin.pred, ylab = "Temperature", main = "North America 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(nalm.fin.pred, ylab = "Temperature", main = "North America 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(nalm.fin.pred, ylab = "Temperature", main = "North America 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
The trend line for North America is not as steep as other Continents. 
...
eu.fin.ts <- ts(eu.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### EU linear model with seasonality and trend 
eu.lm.fin <- tslm(eu.fin.ts ~ trend + season)
eulm.fin.pred <- forecast(eu.lm.fin, h = 12*75)

```

```{r}
autoplot(eulm.fin.pred, ylab = "Temperature", main = "Europe 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(eulm.fin.pred, ylab = "Temperature", main = "Europe 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(eulm.fin.pred, ylab = "Temperature", main = "Europe 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
The 75 year forecast points out that Europe as a continent could be reaching their first 20 degree average month within 75 years. 
...
```{r}
sa.fin.ts <- ts(sa.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### SA linear model with seasonality and trend 
sa.lm.fin <- tslm(sa.fin.ts ~ trend + season)
salm.fin.pred <- forecast(sa.lm.fin, h = 12*75)

```

```{r}
autoplot(salm.fin.pred, ylab = "Temperature", main = "South America 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(salm.fin.pred, ylab = "Temperature", main = "South America 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(salm.fin.pred, ylab = "Temperature", main = "South America 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
The South America 75 year forecast looks to increase by about 2 degrees with confidence intervals taken into a account. 
...
af.fin.ts <- ts(af.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### Africa linear model with seasonality and trend 
af.lm.fin <- tslm(af.fin.ts ~ trend + season)
aflm.fin.pred <- forecast(af.lm.fin, h = 12*75)
...
```{r}
autoplot(aflm.fin.pred, ylab = "Temperature", main = "Africa 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(aflm.fin.pred, ylab = "Temperature", main = "Africa 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(aflm.fin.pred, ylab = "Temperature", main = "Africa 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
The Africa 75 year forecast is very sharp linear trend. Continents with overall hotter temperatures would be expected to increase more proportionally. 
...
as.fin.ts <- ts(as.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### Asia linear model with seasonality and trend 
as.lm.fin <- tslm(as.fin.ts ~ trend + season)
aslm.fin.pred <- forecast(as.lm.fin, h = 12*75)
...
```{r}
autoplot(aslm.fin.pred, ylab = "Temperature", main = "Asia 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(aslm.fin.pred, ylab = "Temperature", main = "Asia 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(aslm.fin.pred, ylab = "Temperature", main = "Asia 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
Asia forecasting shows a sharper 75 year trend line than other continents, which is expected as the original decomposition chart showed the sharpest trend. Additionally, the climate effects may be more centralized here compared to North America or Australia considering that. 
...
au.fin.ts <- ts(au.temps$AverageTemperature, start = c(1900,1), frequency = 12)
### AU linear model with seasonality and trend 
au.lm.fin <- tslm(au.fin.ts ~ trend + season)
aulm.fin.pred <- forecast(au.lm.fin, h = 12*75)

```

```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", main = "Australia 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", main = "Australia 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", main = "Australia 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
Looking at the forecasts, there is the linear trend line of the data that does somewhat match what can be seen in the decomposition trend. 

### Plotting all final forecasts (Linear Regression)

```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", series = "Australia",
         main = "First 25 Years Forecast for all continents") + 
  autolayer(aslm.fin.pred, series = "Asia") + 
  autolayer(aflm.fin.pred, series = "Africa") +
  autolayer(salm.fin.pred, series = "South America") + 
  autolayer(eulm.fin.pred, series = "Europe") + 
  autolayer(nalm.fin.pred, series = "North America") + 
  xlim(2013, 2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
In the Early years, Australia has the hottest peaks of the forecast at nearly 30 degrees celsius. Africa and South America are also quite high. North America has the lowest at -10 degrees celsius within the forecast. 

```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", series = "Australia",
         main = "Middle 25 Years Forecast for all continents") + 
  autolayer(aslm.fin.pred, series = "Asia") + 
  autolayer(aflm.fin.pred, series = "Africa") +
  autolayer(salm.fin.pred, series = "South America") + 
  autolayer(eulm.fin.pred, series = "Europe") + 
...
Looking at the next 25 years of the forecast, it seems that North America winter lows have crept up a tiny bit. Additionally, Australia seems to be climbing over 30 degrees celsius. 


```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", series = "Australia",
         main = "Last 25 Years Forecast for all continents") + 
  autolayer(aslm.fin.pred, series = "Asia") + 
  autolayer(aflm.fin.pred, series = "Africa") +
  autolayer(salm.fin.pred, series = "South America") + 
  autolayer(eulm.fin.pred, series = "Europe") + 
...
Observing the last 25 years of the 75 year forecast, it appears that all continents have shifted upwards as the overall trend of the data the models have been trained on have been an upward shift in surface temperature, that is to be expected. 
