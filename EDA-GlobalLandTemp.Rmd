...
summary(na_nn.pred)
accuracy(na_nn.pred$mean, na.val.ts)
```
...
```{r}
autoplot(na.train.ts, ylab = "Temperature")+
  autolayer(na_nn.pred$fitted)+
  autolayer(nalm.pred$fitted)

autoplot(na.val.ts, ylab = "Temperature")+
...
summary(eu_nn.pred)
accuracy(eu_nn.pred$mean, eu.val.ts)
```
...
```{r}
autoplot(eu.train.ts, ylab = "Temperature")+
  autolayer(eu_nn.pred$fitted)+
  autolayer(eulm.pred$fitted)

autoplot(eu.val.ts, ylab = "Temperature")+
...
summary(sa_nn.pred)
accuracy(sa_nn.pred$mean, sa.val.ts)
```
...
```{r}
autoplot(sa.train.ts, ylab = "Temperature")+
  autolayer(sa_nn.pred$fitted)+
  autolayer(salm.pred$fitted)

autoplot(sa.val.ts, ylab = "Temperature")+
...
summary(af_nn.pred)
accuracy(af_nn.pred$mean, af.val.ts)
```



```{r}
plot(af.train.ts, xlim = c(2005,2015),ylab = "Temperature")
...
```{r}
autoplot(af.train.ts, ylab = "Temperature")+
  autolayer(af_nn.pred$fitted)+
  autolayer(aflm.pred$fitted)

autoplot(af.val.ts, ylab = "Temperature")+
...
summary(as_nn.pred)
accuracy(as_nn.pred$mean, as.val.ts)
```



```{r}
plot(as.train.ts, xlim = c(2005,2015), ylab = "Temperature")
...
```{r}
autoplot(as.train.ts, ylab = "Temperature")+
  autolayer(as_nn.pred$fitted)+
  autolayer(aslm.pred$fitted)

autoplot(as.val.ts, ylab = "Temperature")+
...
summary(nn.pred)
accuracy(nn.pred$mean, au.val.ts)
```



```{r}
plot(au.train.ts, ylim = c(13, 30), xlim = c(2005,2020), ylab = "Temperature")
...
```{r}
autoplot(au.train.ts, ylab = "Temperature")+
  autolayer(nn.pred$fitted)+
  autolayer(aulm.pred$fitted)

autoplot(au.val.ts, ylab = "Temperature")+
