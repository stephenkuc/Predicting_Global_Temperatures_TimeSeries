...
```{r}
autoplot(aulm.fin.pred, ylab = "Temperature", series = "Australia") + autolayer(aslm.fin.pred, series = "Asia") + autolayer(aflm.fin.pred, series = "Africa") +
  autolayer(salm.fin.pred, series = "South America") + autolayer(eulm.fin.pred, series = "Europe") + autolayer(nalm.fin.pred, series = "North America") + xlim(2010, 2075)
