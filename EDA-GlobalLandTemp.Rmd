...
na.fin.hw <- ets(na.fin.ts, model = "ANA", alpha = 0.2)

na.fin.pred <- forecast(na.fin.hw, h = 12 * 75)
na.fin.pred
```


```{r}
autoplot(na.fin.pred, ylab = "Temperature", main = "North America 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(na.fin.pred, ylab = "Temperature", main = "North America 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(na.fin.pred, ylab = "Temperature", main = "North America 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
# training Linear reg on North America
...
eu.fin.hw <- ets(eu.fin.ts, model = "AAA", alpha = 0.2)

eu.fin.pred <- forecast(eu.fin.hw, h = 12 * 75)
eu.fin.pred
```

```{r}
autoplot(eu.fin.pred, ylab = "Temperature", main = "Europe 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(eu.fin.pred, ylab = "Temperature", main = "Europe 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(eu.fin.pred, ylab = "Temperature", main = "Europe 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
sa.fin.hw <- ets(sa.fin.ts, model = "ANA", alpha = 0.2)

sa.fin.pred <- forecast(sa.fin.hw, h = 12 * 75)
sa.fin.pred
```


```{r}
autoplot(sa.fin.pred, ylab = "Temperature", main = "South America 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(sa.fin.pred, ylab = "Temperature", main = "South America 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(sa.fin.pred, ylab = "Temperature", main = "South America 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
af.fin.hw <- ets(af.fin.ts, model = "ANA", alpha = 0.2)

af.fin.pred <- forecast(af.fin.hw, h = 12 * 75)
af.fin.pred
```
...
```{r}
autoplot(af.fin.pred, ylab = "Temperature", main = "Africa 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(af.fin.pred, ylab = "Temperature", main = "Africa 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(af.fin.pred, ylab = "Temperature", main = "Africa 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
as.fin.hw <- ets(as.fin.ts, model = "ANA", alpha = 0.2)

as.fin.pred <- forecast(as.fin.hw, h = 12 * 75)
as.fin.pred
```


```{r}
autoplot(as.fin.pred, ylab = "Temperature", main = "Asia 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(as.fin.pred, ylab = "Temperature", main = "Asia 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(as.fin.pred, ylab = "Temperature", main = "Asia 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
au.fin.hw <- ets(au.fin.ts, model = "ANA", alpha = 0.2)

au.fin.pred <- forecast(au.fin.hw, h = 12 * 75)
au.fin.pred
```


```{r}
autoplot(au.fin.pred, ylab = "Temperature", main = "Australia 75 year Forecast")+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
...
```{r}
autoplot(au.fin.pred, ylab = "Temperature", main = "Australia 25 year Forecast")+
  xlim(2013,2038)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
...
```{r}
autoplot(au.fin.pred, ylab = "Temperature", main = "Australia 50 year Forecast")+
  xlim(2013,2063)+
  theme(axis.text.x = element_text(vjust = 0.7, size = 8),
        plot.title = element_text(hjust = 0.5),
        panel.background = element_blank(),
